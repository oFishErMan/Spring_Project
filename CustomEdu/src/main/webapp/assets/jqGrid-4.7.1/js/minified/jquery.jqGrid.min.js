...
*/
(function(a){a.jgrid=a.jgrid||{};a.extend(a.jgrid,{version:"4.7.1",htmlDecode:function(a){return a&&("&nbsp;"===a||"&#160;"===a||1===a.length&&160===a.charCodeAt(0))?"":a?String(a).replace(/&gt;/g,">").replace(/&lt;/g,"<").replace(/&quot;/g,'"').replace(/&amp;/g,"&"):a},htmlEncode:function(a){return a?String(a).replace(/&/g,"&amp;").replace(/\"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):a},format:function(b){var e=a.makeArray(arguments).slice(1);null==b&&(b="");return b.replace(/\{(\d+)\}/g,
...
1:0)+(!0===b.rownumbers?1:0),q=b.scroll?a.jgrid.randId():1,u,s,t;if("local"===b.datatype&&!0===p.repeatitems)for(u=A(r),s=y("local"),g=!1===b.keyIndex?a.isFunction(p.id)?p.id.call(d,c):p.id:b.keyIndex,b=0;b<e;b++){h=c[b];f=a.jgrid.getAccessor(h,g);void 0===f&&("number"===typeof g&&null!=n[g+r]&&(f=a.jgrid.getAccessor(h,n[g+r].name)),void 0===f&&(f=q+b,m&&(k=a.jgrid.getAccessor(h,m)||h,f=null!=k&&void 0!==k[g]?k[g]:f)));k={};k[p.id]=f;m&&(h=a.jgrid.getAccessor(h,m)||h);t=a.isArray(h)?u:s;for(f=0;f<
...
(l+=" "+p+"="+g[p])}return'<tr role="row" id="'+b+'" tabindex="'+k+'" class="'+e+'"'+(""===c?"":' style="'+c+'"')+l+">"},C=function(b,c,e,f,h){var g=new Date,k="local"!==d.p.datatype&&d.p.loadonce||"xmlstring"===d.p.datatype,l=d.p.xmlReader,p="local"===d.p.datatype?"local":"xml";k&&(d.p.data=[],d.p._index={},d.p.localReader.id="_id_");d.p.reccount=0;if(a.isXMLDoc(b)){-1!==d.p.treeANode||d.p.scroll?e=1<e?e:1:(v.call(d,!1,!0),e=1);var n=a(d),m,q,t=0,B,K=!0===d.p.multiselect?1:0,x=0,Z,C=!0===d.p.rownumbers?
1:0,H,I=[],O,z={},F,J,E=[],M=!0===d.p.altRows?d.p.altclass:"",ha;!0===d.p.subGrid&&(x=1,Z=a.jgrid.getMethod("addSubGridCell"));l.repeatitems||(I=y(p));H=!1===d.p.keyName?a.isFunction(l.id)?l.id.call(d,b):l.id:d.p.keyName;p=-1===String(H).indexOf("[")?I.length?function(b,d){return a(H,b).text()||d}:function(b,d){return a(l.cell,b).eq(H).text()||d}:function(a,b){return a.getAttribute(H.replace(/[\[\]]/g,""))||b};d.p.userData={};d.p.page=r(a.jgrid.getXmlData(b,l.page),d.p.page);d.p.lastpage=r(a.jgrid.getXmlData(b,
l.total),1);d.p.records=r(a.jgrid.getXmlData(b,l.records));a.isFunction(l.userdata)?d.p.userData=l.userdata.call(d,b)||{}:a.jgrid.getXmlData(b,l.userdata,!0).each(function(){d.p.userData[this.getAttribute("name")]=a(this).text()});b=a.jgrid.getXmlData(b,l.root,!0);(b=a.jgrid.getXmlData(b,l.row,!0))||(b=[]);var R=b.length,G=0,T=[],L=parseInt(d.p.rowNum,10),N=d.p.scroll?a.jgrid.randId():1;0<R&&0>=d.p.page&&(d.p.page=1);if(b&&R){h&&(L*=h+1);h=a.isFunction(d.p.afterInsertRow);var V=!1,S;d.p.grouping&&
(V=!0===d.p.groupingView.groupCollapse,S=a.jgrid.getMethod("groupingPrepare"));for(;G<R;){F=b[G];J=p(F,N+G);J=d.p.idPrefix+J;m=0===e?0:e+1;ha=1===(m+G)%2?M:"";var ca=E.length;E.push("");C&&E.push(s(0,G,d.p.page,d.p.rowNum));K&&E.push(w(J,C,G,!1));x&&E.push(Z.call(n,K+C,G+e));if(l.repeatitems){O||(O=A(K+x+C));var ba=a.jgrid.getXmlData(F,l.cell,!0);a.each(O,function(a){var b=ba[this];if(!b)return!1;B=b.textContent||b.text;z[d.p.colModel[a+K+x+C].name]=B;E.push(u(J,B,a+K+x+C,G+e,F,z))})}else for(m=0;m<
I.length;m++)B=a.jgrid.getXmlData(F,I[m]),z[d.p.colModel[m+K+x+C].name]=B,E.push(u(J,B,m+K+x+C,G+e,F,z));E[ca]=D(J,V,ha,z,F,!1);E.push("</tr>");d.p.grouping&&(T.push(E),d.p.groupingView._locgr||S.call(n,z,G),E=[]);if(k||!0===d.p.treeGrid)z._id_=a.jgrid.stripPref(d.p.idPrefix,J),d.p.data.push(z),d.p._index[z._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("tbody:first",c).append(E.join("")),n.triggerHandler("jqGridAfterInsertRow",[J,z,F]),h&&d.p.afterInsertRow.call(d,J,z,F),E=[]);z={};t++;G++;if(t===
L)break}}!0===d.p.gridview&&(q=-1<d.p.treeANode?d.p.treeANode:0,d.p.grouping?k||(n.jqGrid("groupingRender",T,d.p.colModel.length,d.p.page,L),T=null):!0===d.p.treeGrid&&0<q?a(d.rows[q]).after(E.join("")):(d.firstElementChild.innerHTML+=E.join(""),d.grid.cols=d.rows[0].cells));if(!0===d.p.subGrid)try{n.jqGrid("addSubGrid",K+C)}catch($){}d.p.totaltime=new Date-g;0<t&&0===d.p.records&&(d.p.records=R);E=null;if(!0===d.p.treeGrid)try{n.jqGrid("setTreeNode",q+1,t+q+1)}catch(P){}d.p.reccount=t;d.p.treeANode=
-1;d.p.userDataOnFooter&&n.jqGrid("footerData","set",d.p.userData,!0);k&&(d.p.records=R,d.p.lastpage=Math.ceil(R/L));f||d.updatepager(!1,!0);if(k){for(;t<R;){F=b[t];J=p(F,t+N);J=d.p.idPrefix+J;if(l.repeatitems){O||(O=A(K+x+C));var aa=a.jgrid.getXmlData(F,l.cell,!0);a.each(O,function(a){var b=aa[this];if(!b)return!1;B=b.textContent||b.text;z[d.p.colModel[a+K+x+C].name]=B})}else for(m=0;m<I.length;m++)B=a.jgrid.getXmlData(F,I[m]),z[d.p.colModel[m+K+x+C].name]=B;z._id_=a.jgrid.stripPref(d.p.idPrefix,
J);d.p.grouping&&S.call(n,z,t);d.p.data.push(z);d.p._index[z._id_]=d.p.data.length-1;z={};t++}d.p.grouping&&(d.p.groupingView._locgr=!0,n.jqGrid("groupingRender",T,d.p.colModel.length,d.p.page,L),T=null)}}},F=function(b,c,e,f,h){var g=new Date;if(b){-1!==d.p.treeANode||d.p.scroll?e=1<e?e:1:(v.call(d,!1,!0),e=1);var k,l="local"!==d.p.datatype&&d.p.loadonce||"jsonstring"===d.p.datatype;l&&(d.p.data=[],d.p._index={},d.p.localReader.id="_id_");d.p.reccount=0;"local"===d.p.datatype?(c=d.p.localReader,
k="local"):(c=d.p.jsonReader,k="json");var p=a(d),n=0,m,q,t,B=[],K=d.p.multiselect?1:0,x=!0===d.p.subGrid?1:0,Z,C=!0===d.p.rownumbers?1:0,H=A(K+x+C);k=y(k);var I,z,F,J={},O,E,G=[],ha=!0===d.p.altRows?d.p.altclass:"",R;d.p.page=r(a.jgrid.getAccessor(b,c.page),d.p.page);d.p.lastpage=r(a.jgrid.getAccessor(b,c.total),1);d.p.records=r(a.jgrid.getAccessor(b,c.records));d.p.userData=a.jgrid.getAccessor(b,c.userdata)||{};x&&(Z=a.jgrid.getMethod("addSubGridCell"));F=!1===d.p.keyName?a.isFunction(c.id)?c.id.call(d,
b):c.id:d.p.keyName;z=a.jgrid.getAccessor(b,c.root);null==z&&a.isArray(b)&&(z=b);z||(z=[]);b=z.length;q=0;0<b&&0>=d.p.page&&(d.p.page=1);var M=parseInt(d.p.rowNum,10),T=d.p.scroll?a.jgrid.randId():1,L=!1,S;h&&(M*=h+1);"local"!==d.p.datatype||d.p.deselectAfterSort||(L=!0);var N=a.isFunction(d.p.afterInsertRow),V=[],ca=!1,ba;d.p.grouping&&(ca=!0===d.p.groupingView.groupCollapse,ba=a.jgrid.getMethod("groupingPrepare"));for(;q<b;){h=z[q];E=a.jgrid.getAccessor(h,F);void 0===E&&("number"===typeof F&&null!=
d.p.colModel[F+K+x+C]&&(E=a.jgrid.getAccessor(h,d.p.colModel[F+K+x+C].name)),void 0===E&&(E=T+q,0===B.length&&c.cell&&(m=a.jgrid.getAccessor(h,c.cell)||h,E=null!=m&&void 0!==m[F]?m[F]:E)));E=d.p.idPrefix+E;m=1===e?0:e;R=1===(m+q)%2?ha:"";L&&(S=d.p.multiselect?-1!==a.inArray(E,d.p.selarrrow):E===d.p.selrow);var $=G.length;G.push("");C&&G.push(s(0,q,d.p.page,d.p.rowNum));K&&G.push(w(E,C,q,S));x&&G.push(Z.call(p,K+C,q+e));I=k;c.repeatitems&&(c.cell&&(h=a.jgrid.getAccessor(h,c.cell)||h),a.isArray(h)&&
(I=H));for(t=0;t<I.length;t++)m=a.jgrid.getAccessor(h,I[t]),J[d.p.colModel[t+K+x+C].name]=m,G.push(u(E,m,t+K+x+C,q+e,h,J));G[$]=D(E,ca,R,J,h,S);G.push("</tr>");d.p.grouping&&(V.push(G),d.p.groupingView._locgr||ba.call(p,J,q),G=[]);if(l||!0===d.p.treeGrid)J._id_=a.jgrid.stripPref(d.p.idPrefix,E),d.p.data.push(J),d.p._index[J._id_]=d.p.data.length-1;!1===d.p.gridview&&(a("#"+a.jgrid.jqID(d.p.id)+" tbody:first").append(G.join("")),p.triggerHandler("jqGridAfterInsertRow",[E,J,h]),N&&d.p.afterInsertRow.call(d,
E,J,h),G=[]);J={};n++;q++;if(n===M)break}!0===d.p.gridview&&(O=-1<d.p.treeANode?d.p.treeANode:0,d.p.grouping?l||(p.jqGrid("groupingRender",V,d.p.colModel.length,d.p.page,M),V=null):!0===d.p.treeGrid&&0<O?a(d.rows[O]).after(G.join("")):(d.firstElementChild.innerHTML+=G.join(""),d.grid.cols=d.rows[0].cells));if(!0===d.p.subGrid)try{p.jqGrid("addSubGrid",K+C)}catch(P){}d.p.totaltime=new Date-g;0<n&&0===d.p.records&&(d.p.records=b);if(!0===d.p.treeGrid)try{p.jqGrid("setTreeNode",O+1,n+O+1)}catch(aa){}d.p.reccount=
n;d.p.treeANode=-1;d.p.userDataOnFooter&&p.jqGrid("footerData","set",d.p.userData,!0);l&&(d.p.records=b,d.p.lastpage=Math.ceil(b/M));f||d.updatepager(!1,!0);if(l){for(;n<b&&z[n];){h=z[n];E=a.jgrid.getAccessor(h,F);void 0===E&&("number"===typeof F&&null!=d.p.colModel[F+K+x+C]&&(E=a.jgrid.getAccessor(h,d.p.colModel[F+K+x+C].name)),void 0===E&&(E=T+n,0===B.length&&c.cell&&(e=a.jgrid.getAccessor(h,c.cell)||h,E=null!=e&&void 0!==e[F]?e[F]:E)));if(h){E=d.p.idPrefix+E;I=k;c.repeatitems&&(c.cell&&(h=a.jgrid.getAccessor(h,
c.cell)||h),a.isArray(h)&&(I=H));for(t=0;t<I.length;t++)J[d.p.colModel[t+K+x+C].name]=a.jgrid.getAccessor(h,I[t]);J._id_=a.jgrid.stripPref(d.p.idPrefix,E);d.p.grouping&&ba.call(p,J,n);d.p.data.push(J);d.p._index[J._id_]=d.p.data.length-1;J={}}n++}d.p.grouping&&(d.p.groupingView._locgr=!0,p.jqGrid("groupingRender",V,d.p.colModel.length,d.p.page,M))}}},x=function(){function b(a){var d=0,c,e,f,g,k;if(null!=a.groups){(e=a.groups.length&&"OR"===a.groupOp.toString().toUpperCase())&&u.orBegin();for(c=0;c<
...
[];var x,B=a.jgrid.getMethod("groupingPrepare"),C,Z;if(d.p.footerrow&&d.p.userDataOnFooter){for(C in d.p.userData)d.p.userData.hasOwnProperty(C)&&(d.p.userData[C]=0);Z=!0}for(x=0;x<w;x++){if(Z)for(C in d.p.userData)d.p.userData[C]+=parseFloat(s[x][C]||0);B.call(a(d),s[x],x,v)}}s=s.slice((D-1)*v,D*v);h=u=null;K[d.p.localReader.total]=A;K[d.p.localReader.page]=D;K[d.p.localReader.records]=w;K[d.p.localReader.root]=s;K[d.p.localReader.userdata]=d.p.userData;s=null;return K}}},M=function(){d.grid.hDiv.loading=
...
d.p.jsonReader);d.p.localReader=a.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},d.p.localReader);d.p.scroll&&(d.p.pgbuttons=!1,d.p.pginput=!1,d.p.rowList=[]);d.p.data.length&&(H(),B());N="<thead><tr class='ui-jqgrid-labels' role='row'>";var J,O,V,T,R,G,I,ea,ca=ea="",ga=[],ba=[];O=[];if(!0===d.p.shrinkToFit&&!0===d.p.forceFit)for(k=d.p.colModel.length-1;0<=k;k--)if(!d.p.colModel[k].hidden){d.p.colModel[k].resizable=
!1;break}"horizontal"===d.p.viewsortcols[1]&&(ea=" ui-i-asc",ca=" ui-i-desc");J=c?"class='ui-th-div-ie'":"";ea="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+ea+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+l+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+ca+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+l+"'></span></span>");if(d.p.multiSort)for(ga=d.p.sortname.split(","),k=0;k<ga.length;k++)O=a.trim(ga[k]).split(" "),
ga[k]=a.trim(O[0]),ba[k]=O[1]?a.trim(O[1]):d.p.sortorder||"asc";for(k=0;k<this.p.colNames.length;k++)O=d.p.headertitles?' title="'+a.jgrid.stripHtml(d.p.colNames[k])+'"':"",N+="<th id='"+d.p.id+"_"+d.p.colModel[k].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+l+"'"+O+">",O=d.p.colModel[k].index||d.p.colModel[k].name,N+="<div id='jqgh_"+d.p.id+"_"+d.p.colModel[k].name+"' "+J+">"+d.p.colNames[k],d.p.colModel[k].width=d.p.colModel[k].width?parseInt(d.p.colModel[k].width,10):
150,"boolean"!==typeof d.p.colModel[k].title&&(d.p.colModel[k].title=!0),d.p.colModel[k].lso="",O===d.p.sortname&&(d.p.lastsort=k),d.p.multiSort&&(O=a.inArray(O,ga),-1!==O&&(d.p.colModel[k].lso=ba[O])),N+=ea+"</div></th>";N+="</tr></thead>";ea=null;a(this).append(N);a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});if(this.p.multiselect){var ia=[],$;a("#cb_"+a.jgrid.jqID(d.p.id),this).bind("click",function(){d.p.selarrrow=
...
a.jgrid.jqID(d.p.id)+"_"+a.jgrid.jqID(this.id),d.grid.fbDiv)[d.p.useProp?"prop":"attr"]("checked",!1),a("#"+a.jgrid.jqID(this.id),d.grid.fbDiv).removeClass("ui-state-highlight")))}),d.p.selrow=null,$=!1);a(d).triggerHandler("jqGridSelectAll",[$?d.p.selarrrow:ia,$]);a.isFunction(d.p.onSelectAll)&&d.p.onSelectAll.call(d,$?d.p.selarrrow:ia,$)})}!0===d.p.autowidth&&(N=a(m).innerWidth(),d.p.width=0<N?N:"nw");(function(){var b=0,c=a.jgrid.cell_width?0:r(d.p.cellLayout,0),e=0,f,g=r(d.p.scrollOffset,0),k,
...
a(m).css("width",h.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+d.p.id+"'>&#160;</div>");a(p).css("width",h.width+"px");N=a("thead:first",d).get(0);var da="";d.p.footerrow&&(da+="<table role='presentation' style='width:"+d.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+l+"'>");var p=a("tr:first",N),fa="<tr class='jqgfirstrow' role='row' style='height:auto'>";d.p.disableClick=!1;
a("th",p).each(function(b){V=d.p.colModel[b].width;void 0===d.p.colModel[b].resizable&&(d.p.colModel[b].resizable=!0);d.p.colModel[b].resizable?(T=document.createElement("span"),a(T).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+l).css("cursor","col-resize"),a(this).addClass(d.p.resizeclass)):T="";a(this).css("width",V+"px").prepend(T);T=null;var c="";d.p.colModel[b].hidden&&(a(this).css("display","none"),c="display:none;");fa+="<td role='gridcell' style='height:0px;width:"+V+"px;"+
c+"'></td>";h.headers[b]={width:V,el:this};R=d.p.colModel[b].sortable;"boolean"!==typeof R&&(R=d.p.colModel[b].sortable=!0);c=d.p.colModel[b].name;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&d.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");R&&(d.p.multiSort?d.p.viewsortcols[0]?(a("div span.s-ico",this).show(),d.p.colModel[b].lso&&a("div span.ui-icon-"+d.p.colModel[b].lso,this).removeClass("ui-state-disabled")):d.p.colModel[b].lso&&(a("div span.s-ico",this).show(),a("div span.ui-icon-"+d.p.colModel[b].lso,
...
(W||d.p.onHeaderClick.call(d,d.p.gridstate,b)))});return!1}),W&&(d.p.datatype="local",a(".ui-jqgrid-titlebar-close",h.cDiv).trigger("click")))}else a(h.cDiv).hide(),d.p.toppager||a(h.hDiv).addClass("ui-corner-top");a(h.hDiv).after(h.bDiv).mousemove(function(a){if(h.resizing)return h.dragMove(a),!1});a(".ui-jqgrid-labels",h.hDiv).bind("selectstart",function(){return!1});a(document).bind("mouseup.jqGrid"+d.p.id,function(){return h.resizing?(h.dragEnd(),!1):!0});d.formatCol=q;d.sortData=E;d.updatepager=
function(b,c){var e,f,h,g,k,l,p,n="",m=d.p.pager?"_"+a.jgrid.jqID(d.p.pager.substr(1)):"",q=d.p.toppager?"_"+d.p.toppager.substr(1):"";h=parseInt(d.p.page,10)-1;0>h&&(h=0);h*=parseInt(d.p.rowNum,10);k=h+d.p.reccount;if(d.p.scroll){e=a("tbody:first > tr:gt(0)",d.grid.bDiv);h=k-e.length;d.p.reccount=e.length;if(e=e.outerHeight()||d.grid.prevRowHeight)f=h*e,p=parseInt(d.p.records,10)*e,a(">div:first",d.grid.bDiv).css({height:p}).children("div:first").css({height:f,display:f?"":"none"}),0==d.grid.bDiv.scrollTop&&
...
p&&(n=this.formatCol(0,1,"",null,b,!0),h[h.length]='<td role="gridcell" class="ui-state-default jqgrid-rownum" '+n+">0</td>");k&&(q='<input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+b+'" class="cbox"/>',n=this.formatCol(p,1,"",null,b,!0),h[h.length]='<td role="gridcell" '+n+">"+q+"</td>");l&&(h[h.length]=a(this).jqGrid("addSubGridCell",k+p,1));for(r=k+l+p;r<this.p.colModel.length;r++)y=this.p.colModel[r],d=y.name,D[d]=s[d],q=this.formatter(b,a.jgrid.getAccessor(s,d),r,s),n=this.formatCol(r,
...
"":k.editoptions.value,w=void 0===k.editoptions.separator?":":k.editoptions.separator,s=void 0===k.editoptions.delimiter?";":k.editoptions.delimiter);if(u){var y=document.createElement("select");y.style.width="100%";a(y).attr({name:k.index||k.name,id:"gs_"+k.name});var A;if("string"===typeof u)for(p=u.split(s),A=0;A<p.length;A++)u=p[A].split(w),s=document.createElement("option"),s.value=u[0],s.innerHTML=u[1],y.appendChild(s);else if("object"===typeof u)for(A in u)u.hasOwnProperty(A)&&(s=document.createElement("option"),
s.value=A,s.innerHTML=u[A],y.appendChild(s));void 0!==l.defaultValue&&a(y).val(l.defaultValue);l.attr&&a(y).attr(l.attr);a(n).append(t);a.jgrid.bindEv.call(e,y,l);a("td:eq(1)",t).append(y);!0===b.autosearch&&a(y).change(function(){c();return!1})}}break;case "text":w=void 0!==l.defaultValue?l.defaultValue:"";a("td:eq(1)",t).append("<input type='text' style='width:100%;padding:0px;' name='"+(k.index||k.name)+"' id='gs_"+k.name+"' value='"+w+"'/>");a(n).append(t);l.attr&&a("input",n).attr(l.attr);a.jgrid.bindEv.call(e,
a("input",n)[0],l);!0===b.autosearch&&(b.searchOnEnter?a("input",n).keypress(function(a){return 13===(a.charCode||a.keyCode||0)?(c(),!1):this}):a("input",n).keydown(function(a){switch(a.which){case 13:return!1;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:d&&clearTimeout(d),d=setTimeout(function(){c()},b.autosearchDelay)}}));break;case "custom":a("td:eq(1)",t).append("<span style='width:95%;padding:0px;' name='"+(k.index||k.name)+"' id='gs_"+k.name+"'/>");a(n).append(t);try{if(a.isFunction(l.custom_element))if(y=
l.custom_element.call(e,void 0!==l.defaultValue?l.defaultValue:"",l))y=a(y).addClass("customelement"),a(n).find("span[name='"+(k.index||k.name)+"']").append(y);else throw"e2";else throw"e1";}catch(v){"e1"===v&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===v?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===
...
0;e<b.groups.length;e++)g=a("<tr></tr>"),h.append(g),k=a("<td class='first'></td>"),g.append(k),k=a("<td colspan='4'></td>"),k.append(this.createTableForGroup(b.groups[e],b)),g.append(k);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)h.append(this.createTableRowForRule(b.rules[e],b));return h};this.createTableRowForRule=function(b,c){var d=this,e=a("#"+a.jgrid.jqID(f.id))[0]||null,h=a("<tr></tr>"),g,l,w,s,y="",A;h.append("<td class='first'></td>");
...
void 0===d.p.columns[g].search?!0:d.p.columns[g].search;var C=!0===d.p.columns[g].hidden;if(!0===d.p.columns[g].searchoptions.searchhidden&&A||A&&!C)A="",b.field===d.p.columns[g].name&&(A=" selected='selected'",v=g),y+="<option value='"+d.p.columns[g].name+"'"+A+">"+d.p.columns[g].label+"</option>"}H.append(y);y=a("<td class='operators'></td>");h.append(y);s=f.columns[v];s.searchoptions.id=a.jgrid.randId();k&&"text"===s.inputtype&&!s.searchoptions.size&&(s.searchoptions.size=10);v=a.jgrid.createEl.call(e,
s.inputtype,s.searchoptions,b.data,!0,d.p.ajaxSelectOptions||{},!0);if("nu"===b.op||"nn"===b.op)a(v).attr("readonly","true"),a(v).attr("disabled","true");var F=a("<select class='selectopts'></select>");y.append(F);F.bind("change",function(){b.op=a(F).val();w=a(this).parents("tr:first");var c=a(".input-elm",w)[0];"nu"===b.op||"nn"===b.op?(b.data="","SELECT"!==c.tagName.toUpperCase()&&(c.value=""),c.setAttribute("readonly","true"),c.setAttribute("disabled","true")):("SELECT"===c.tagName.toUpperCase()&&
(b.data=c.value),c.removeAttribute("readonly"),c.removeAttribute("disabled"));d.onchange()});l=s.searchoptions.sopt?s.searchoptions.sopt:d.p.sopt?d.p.sopt:-1!==a.inArray(s.searchtype,d.p.strarr)?d.p.stropts:d.p.numopts;y="";a.each(d.p.ops,function(){D.push(this.oper)});for(g=0;g<l.length;g++)B=a.inArray(l[g],D),-1!==B&&(A=b.op===d.p.ops[B].oper?" selected='selected'":"",y+="<option value='"+d.p.ops[B].oper+"'"+A+">"+d.p.ops[B].text+"</option>");F.append(y);y=a("<td class='data'></td>");h.append(y);
y.append(v);a.jgrid.bindEv.call(e,v,s.searchoptions);a(v).addClass("input-elm").bind("change",function(){b.data="custom"===s.inputtype?s.searchoptions.custom_value.call(e,a(this).children(".customelement:first"),"get"):a(this).val();d.onchange()});y=a("<td></td>");h.append(y);!0===this.p.ruleButtons&&(v=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),y.append(v),v.bind("click",function(){for(g=0;g<c.rules.length;g++)if(c.rules[g]===b){c.rules.splice(g,1);break}d.reDraw();
...
b.Find+"</a>",u="<a id='"+g+"_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>"+b.Reset+"</a>",w="",s="",y,A=!1,v=-1;b.showQuery&&(w="<a id='"+g+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");b.columns.length?(n=b.columns,v=0,y=n[0].index||n[0].name):a.each(n,function(a,b){b.label||(b.label=f.p.colNames[a]);if(!A){var c=
void 0===b.search?!0:b.search,d=!0===b.hidden;if(b.searchoptions&&!0===b.searchoptions.searchhidden&&c||c&&!d)A=!0,y=b.index||b.name,v=a}});if(!l&&y||!1===b.multipleSearch){var H="eq";0<=v&&n[v].searchoptions&&n[v].searchoptions.sopt?H=n[v].searchoptions.sopt[0]:b.sopt&&b.sopt.length&&(H=b.sopt[0]);l={groupOp:"AND",rules:[{field:y,op:H,data:""}]}}A=!1;b.tmplNames&&b.tmplNames.length&&(A=!0,s=b.tmplLabel,s+="<select class='ui-template'>",s+="<option value='default'>Default</option>",a.each(b.tmplNames,
...
a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,p.message,a.jgrid.edit.bClose)}}g++}}),0<g&&a("#id_g",s).val(c))}}function h(){a.each(n.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&x.hasOwnProperty(b.name)&&""===x[b.name]&&(x[b.name]="null")})}function k(){var e,f=[!0,"",""],g={},k=n.p.prmNames,l,m,p,q,r,v=a(n).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+u),z]);v&&"object"===typeof v&&(x=v);a.isFunction(b[n.p.id].beforeCheckValues)&&(v=b[n.p.id].beforeCheckValues.call(n,
x,a("#"+u),z))&&"object"===typeof v&&(x=v);for(p in x)if(x.hasOwnProperty(p)&&(f=a.jgrid.checkValues.call(n,x[p],p),!1===f[0]))break;h();f[0]&&(g=a(n).triggerHandler("jqGridAddEditClickSubmit",[b[n.p.id],x,z]),void 0===g&&a.isFunction(b[n.p.id].onclickSubmit)&&(g=b[n.p.id].onclickSubmit.call(n,b[n.p.id],x,z)||{}),f=a(n).triggerHandler("jqGridAddEditBeforeSubmit",[x,a("#"+u),z]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].beforeSubmit)&&(f=b[n.p.id].beforeSubmit.call(n,x,a("#"+u),z)));
if(f[0]&&!b[n.p.id].processing){b[n.p.id].processing=!0;a("#sData",s+"_2").addClass("ui-state-active");p=b[n.p.id].url||a(n).jqGrid("getGridParam","editurl");m=k.oper;l="clientArray"===p?n.p.keyName:k.id;x[m]="_empty"===a.trim(x[n.p.id+"_id"])?k.addoper:k.editoper;x[m]!==k.addoper?x[l]=x[n.p.id+"_id"]:void 0===x[l]&&(x[l]=x[n.p.id+"_id"]);delete x[n.p.id+"_id"];x=a.extend(x,b[n.p.id].editData,g);if(!0===n.p.treeGrid)for(r in x[m]===k.addoper&&(q=a(n).jqGrid("getGridParam","selrow"),x["adjacency"===
n.p.treeGridModel?n.p.treeReader.parent_id_field:"parent_id"]=q),n.p.treeReader)n.p.treeReader.hasOwnProperty(r)&&(g=n.p.treeReader[r],!x.hasOwnProperty(g)||x[m]===k.addoper&&"parent_id_field"===r||delete x[g]);x[l]=a.jgrid.stripPref(n.p.idPrefix,x[l]);r=a.extend({url:p,type:b[n.p.id].mtype,data:a.isFunction(b[n.p.id].serializeEditData)?b[n.p.id].serializeEditData.call(n,x):x,complete:function(g,h){var p;a("#sData",s+"_2").removeClass("ui-state-active");x[l]=n.p.idPrefix+x[l];300<=g.status&&304!==
g.status?(f[0]=!1,f[1]=a(n).triggerHandler("jqGridAddEditErrorTextFormat",[g,z]),a.isFunction(b[n.p.id].errorTextFormat)?f[1]=b[n.p.id].errorTextFormat.call(n,g,z):f[1]=h+" Status: '"+g.statusText+"'. Error code: "+g.status):(f=a(n).triggerHandler("jqGridAddEditAfterSubmit",[g,x,z]),void 0===f&&(f=[!0,"",""]),f[0]&&a.isFunction(b[n.p.id].afterSubmit)&&(f=b[n.p.id].afterSubmit.call(n,g,x,z)));if(!1===f[0])a("#FormError>td",s).html(f[1]),a("#FormError",s).show();else if(n.p.autoencode&&a.each(x,function(b,
c){x[b]=a.jgrid.htmlDecode(c)}),x[m]===k.addoper?(f[2]||(f[2]=a.jgrid.randId()),null==x[l]||"_empty"===x[l]?x[l]=f[2]:f[2]=x[l],b[n.p.id].reloadAfterSubmit?a(n).trigger("reloadGrid"):!0===n.p.treeGrid?a(n).jqGrid("addChildNode",f[2],q,x):a(n).jqGrid("addRowData",f[2],x,c.addedrow),b[n.p.id].closeAfterAdd?(!0!==n.p.treeGrid&&a(n).jqGrid("setSelection",f[2]),a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,
formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form})):b[n.p.id].clearAfterAdd&&d("_empty",n,u)):(b[n.p.id].reloadAfterSubmit?(a(n).trigger("reloadGrid"),b[n.p.id].closeAfterEdit||setTimeout(function(){a(n).jqGrid("setSelection",x[l])},1E3)):!0===n.p.treeGrid?a(n).jqGrid("setTreeRow",x[l],x):a(n).jqGrid("setRowData",x[l],x),b[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,
formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form})),a.isFunction(b[n.p.id].afterComplete)&&(e=g,setTimeout(function(){a(n).triggerHandler("jqGridAddEditAfterComplete",[e,x,a("#"+u),z]);b[n.p.id].afterComplete.call(n,e,x,a("#"+u),z);e=null},500)),b[n.p.id].checkOnSubmit||b[n.p.id].checkOnUpdate)if(a("#"+u).data("disabled",!1),"_empty"!==b[n.p.id]._savedData[n.p.id+"_id"])for(p in b[n.p.id]._savedData)b[n.p.id]._savedData.hasOwnProperty(p)&&x[p]&&(b[n.p.id]._savedData[p]=x[p]);b[n.p.id].processing=
!1;try{a(":input:visible","#"+u)[0].focus()}catch(r){}}},a.jgrid.ajaxOptions,b[n.p.id].ajaxEditOptions);r.url||b[n.p.id].useDataProxy||(a.isFunction(n.p.dataProxy)?b[n.p.id].useDataProxy=!0:(f[0]=!1,f[1]+=" "+a.jgrid.errors.nourl));f[0]&&(b[n.p.id].useDataProxy?(g=n.p.dataProxy.call(n,r,"set_"+n.p.id),void 0===g&&(g=[!0,""]),!1===g[0]?(f[0]=!1,f[1]=g[1]||"Error deleting the selected row!"):(r.data.oper===k.addoper&&b[n.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+
a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form}),r.data.oper===k.editoper&&b[n.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form}))):"clientArray"===r.url?(b[n.p.id].reloadAfterSubmit=!1,x=r.data,r.complete({status:200,statusText:""},
"")):a.ajax(r))}!1===f[0]&&(a("#FormError>td",s).html(f[1]),a("#FormError",s).show())}function l(a,b){var c=!1,d;for(d in a)if(a.hasOwnProperty(d)&&a[d]!=b[d]){c=!0;break}return c}function p(){var c=!0;a("#FormError",s).hide();b[n.p.id].checkOnUpdate&&(x={},f(),M=l(x,b[n.p.id]._savedData))&&(a("#"+u).data("disabled",!0),a(".confirm","#"+y.themodal).show(),c=!1);return c}function m(){var b;if("_empty"!==e&&void 0!==n.p.savedRow&&0<n.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(b=0;b<
n.p.savedRow.length;b++)if(n.p.savedRow[b].id==e){a(n).jqGrid("restoreRow",e);break}}function r(b,c){var d=c[1].length-1;0===b?a("#pData",s+"_2").addClass("ui-state-disabled"):void 0!==c[1][b-1]&&a("#"+a.jgrid.jqID(c[1][b-1])).hasClass("ui-state-disabled")?a("#pData",s+"_2").addClass("ui-state-disabled"):a("#pData",s+"_2").removeClass("ui-state-disabled");b===d?a("#nData",s+"_2").addClass("ui-state-disabled"):void 0!==c[1][b+1]&&a("#"+a.jgrid.jqID(c[1][b+1])).hasClass("ui-state-disabled")?a("#nData",
s+"_2").addClass("ui-state-disabled"):a("#nData",s+"_2").removeClass("ui-state-disabled")}function q(){var b=a(n).jqGrid("getDataIDs"),c=a("#id_g",s).val();return[a.inArray(c,b),b]}var n=this;if(n.grid&&e){var t=n.p.id,u="FrmGrid_"+t,w="TblGrid_"+t,s="#"+a.jgrid.jqID(w),y={themodal:"editmod"+t,modalhead:"edithd"+t,modalcontent:"editcnt"+t,scrollelm:u},A=a.isFunction(b[n.p.id].beforeShowForm)?b[n.p.id].beforeShowForm:!1,v=a.isFunction(b[n.p.id].afterShowForm)?b[n.p.id].afterShowForm:!1,H=a.isFunction(b[n.p.id].beforeInitData)?
b[n.p.id].beforeInitData:!1,B=a.isFunction(b[n.p.id].onInitializeForm)?b[n.p.id].onInitializeForm:!1,D=!0,C=1,F=0,x,M,z,u=a.jgrid.jqID(u);"new"===e?(e="_empty",z="add",c.caption=b[n.p.id].addCaption):(c.caption=b[n.p.id].editCaption,z="edit");c.recreateForm||a(n).data("formProp")&&a.extend(b[a(this)[0].p.id],a(n).data("formProp"));var L=!0;c.checkOnUpdate&&c.jqModal&&!c.modal&&(L=!1);var P=isNaN(b[a(this)[0].p.id].dataheight)?b[a(this)[0].p.id].dataheight:b[a(this)[0].p.id].dataheight+"px",D=isNaN(b[a(this)[0].p.id].datawidth)?
b[a(this)[0].p.id].datawidth:b[a(this)[0].p.id].datawidth+"px",P=a("<form name='FormPost' id='"+u+"' class='FormGrid' onSubmit='return false;' style='width:"+D+";overflow:auto;position:relative;height:"+P+";'></form>").data("disabled",!1),U=a("<table id='"+w+"' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>");a(n.p.colModel).each(function(){var a=this.formoptions;C=Math.max(C,a?a.colpos||0:0);F=Math.max(F,a?a.rowpos||0:0)});a(P).append(U);D=a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"+
2*C+"'></td></tr>");D[0].rp=0;a(U).append(D);D=a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"+2*C+"'>"+b[n.p.id].topinfo+"</td></tr>");D[0].rp=0;a(U).append(D);D=a(n).triggerHandler("jqGridAddEditBeforeInitData",[P,z]);void 0===D&&(D=!0);D&&H&&(D=H.call(n,P,z));if(!1!==D){m();var D=(H="rtl"===n.p.direction?!0:!1)?"nData":"pData",X=H?"pData":"nData";g(e,n,U,C);var D="<a id='"+D+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
...
(H?X+D:D+X)+"</td><td class='EditButton'>"+E+aa+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+b[n.p.id].bottominfo+"</td></tr>"),w=w+"</tbody></table>";if(0<F){var S=[];a.each(a(U)[0].rows,function(a,b){S[a]=b});S.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(S,function(b,c){a("tbody",U).append(c)})}c.gbox="#gbox_"+a.jgrid.jqID(t);var N=!1;!0===c.closeOnEscape&&(c.closeOnEscape=!1,N=!0);w=a("<div></div>").append(P).append(w);a.jgrid.createModal(y,
w,b[a(this)[0].p.id],"#gview_"+a.jgrid.jqID(n.p.id),a("#gbox_"+a.jgrid.jqID(n.p.id))[0]);H&&(a("#pData, #nData",s+"_2").css("float","right"),a(".EditButton",s+"_2").css("text-align","left"));b[n.p.id].topinfo&&a(".tinfo",s).show();b[n.p.id].bottominfo&&a(".binfo",s+"_2").show();w=w=null;a("#"+a.jgrid.jqID(y.themodal)).keydown(function(d){var e=d.target;if(!0===a("#"+u).data("disabled"))return!1;if(!0===b[n.p.id].savekey[0]&&d.which===b[n.p.id].savekey[1]&&"TEXTAREA"!==e.tagName)return a("#sData",
s+"_2").trigger("click"),!1;if(27===d.which){if(!p())return!1;N&&a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:c.gbox,jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1}if(!0===b[n.p.id].navkeys[0]){if("_empty"===a("#id_g",s).val())return!0;if(d.which===b[n.p.id].navkeys[1])return a("#pData",s+"_2").trigger("click"),!1;if(d.which===b[n.p.id].navkeys[2])return a("#nData",s+"_2").trigger("click"),!1}});c.checkOnUpdate&&
(a("a.ui-jqdialog-titlebar-close span","#"+a.jgrid.jqID(y.themodal)).removeClass("jqmClose"),a("a.ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(y.themodal)).unbind("click").click(function(){if(!p())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1}));c.saveicon=a.extend([!0,"left","ui-icon-disk"],c.saveicon);c.closeicon=a.extend([!0,
...
c.bYes+"</a>",X="<a id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bNo+"</a>",aa="<a id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+c.bExit+"</a>",w=c.zIndex||999,w++,a("<div class='"+c.overlayClass+" jqgrid-overlay confirm' style='z-index:"+w+";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(w+1)+"'>"+c.saveData+"<br/><br/>"+E+X+aa+"</div>").insertAfter("#"+u),a("#sNew","#"+a.jgrid.jqID(y.themodal)).click(function(){k();
a("#"+u).data("disabled",!1);a(".confirm","#"+a.jgrid.jqID(y.themodal)).hide();return!1}),a("#nNew","#"+a.jgrid.jqID(y.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(y.themodal)).hide();a("#"+u).data("disabled",!1);setTimeout(function(){a(":input:visible","#"+u)[0].focus()},0);return!1}),a("#cNew","#"+a.jgrid.jqID(y.themodal)).click(function(){a(".confirm","#"+a.jgrid.jqID(y.themodal)).hide();a("#"+u).data("disabled",!1);a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),
jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a(n).triggerHandler("jqGridAddEditInitializeForm",[a("#"+u),z]);B&&B.call(n,a("#"+u),z);"_empty"!==e&&b[n.p.id].viewPagerButtons?a("#pData,#nData",s+"_2").show():a("#pData,#nData",s+"_2").hide();a(n).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+u),z]);A&&A.call(n,a("#"+u),z);a("#"+a.jgrid.jqID(y.themodal)).data("onClose",b[n.p.id].onClose);a.jgrid.viewModal("#"+
a.jgrid.jqID(y.themodal),{gbox:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,overlay:c.overlay,modal:c.modal,overlayClass:c.overlayClass,onHide:function(b){var c=a("#editmod"+t)[0].style.height;-1<c.indexOf("px")&&(c=parseFloat(c));a(n).data("formProp",{top:parseFloat(a(b.w).css("top")),left:parseFloat(a(b.w).css("left")),width:a(b.w).width(),height:c,dataheight:a("#"+u).height(),datawidth:a("#"+u).width()});b.w.remove();b.o&&b.o.remove()}});L||a("."+a.jgrid.jqID(c.overlayClass)).click(function(){if(!p())return!1;
a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a(".fm-button","#"+a.jgrid.jqID(y.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData",s+"_2").click(function(){x={};a("#FormError",s).hide();f();"_empty"===x[n.p.id+"_id"]?k():!0===c.checkOnSubmit?(M=l(x,b[n.p.id]._savedData))?
(a("#"+u).data("disabled",!0),a(".confirm","#"+a.jgrid.jqID(y.themodal)).show()):k():k();return!1});a("#cData",s+"_2").click(function(){if(!p())return!1;a.jgrid.hideModal("#"+a.jgrid.jqID(y.themodal),{gb:"#gbox_"+a.jgrid.jqID(t),jqm:c.jqModal,onClose:b[n.p.id].onClose,removemodal:b[n.p.id].removemodal,formprop:!b[n.p.id].recreateForm,form:b[n.p.id].form});return!1});a("#nData",s+"_2").click(function(){if(!p())return!1;a("#FormError",s).hide();var b=q();b[0]=parseInt(b[0],10);if(-1!==b[0]&&b[1][b[0]+
...
t="",u=["integer","number","currency"],v=0,y=0,w,A,B;for(r=1;r<=f;r++)t+=1===r?s:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(d.p.colModel).each(function(){(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==a.inArray(this.formatter,u)?v=Math.max(v,parseInt(this.width,10)):y=Math.max(y,parseInt(this.width,10)))});w=0!==v?v:0!==y?y:0;q=a(d).jqGrid("getInd",
...
modal:b[f.p.id].modal})}else{var s=isNaN(b[f.p.id].dataheight)?b[f.p.id].dataheight:b[f.p.id].dataheight+"px",y=isNaN(c.datawidth)?c.datawidth:c.datawidth+"px",u="<div id='"+u+"' class='formdata' style='width:"+y+";overflow:auto;position:relative;height:"+s+";'><table class='DelTable'><tbody>",u=u+"<tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>",u=u+("<tr id='DelData' style='display:none'><td >"+e+"</td></tr>"),u=u+('<tr><td class="delmsg" style="white-space:pre;">'+
...
"<td "+h.formatCol(p,1,"")+">"+a.jgrid.format(r,n)+"</td>";return!1}});b+=q}return b}var h=this,k=h.p.groupingView,l="",p="",m,r,q=k.groupCollapse?k.plusicon:k.minusicon,n,t=[],u=k.groupField.length,q=q+(" tree-wrap-"+h.p.direction);a.each(h.p.colModel,function(a,b){var c;for(c=0;c<u;c++)if(k.groupField[c]===b.name){t[c]=a;break}});var w=0,s=a.makeArray(k.groupSummary),y;s.reverse();y=h.p.multiselect?' colspan="2"':"";a.each(k.groups,function(g,v){if(k._locgr&&!(v.startRow+v.cnt>(c-1)*f&&v.startRow<
...
r+'"><td style="padding-left:'+12*v.idx+'px;" colspan="'+(!1===k.groupColumnShow[v.idx]?e-1:e)+'">'+p+a.jgrid.template(k.groupText[v.idx],n,v.cnt,v.summary)+"</td></tr>";if(u-1===v.idx){var B=k.groups[g+1],D,C=0;D=v.startRow;var F=void 0!==B?B.startRow:k.groups[g].startRow+k.groups[g].cnt;k._locgr&&(C=(c-1)*f,C>v.startRow&&(D=C));for(;D<F&&b[D-C];D++)l+=b[D-C].join("");if("header"!==k.groupSummaryPos[v.idx]){var x;if(void 0!==B){for(x=0;x<k.groupField.length&&B.dataIndex!==k.groupField[x];x++);w=
k.groupField.length-x}for(B=0;B<w;B++)s[B]&&(C="",k.groupCollapse&&!k.showSummaryOnHide&&(C=' style="display:none;"'),l+="<tr"+C+' jqfootlevel="'+(v.idx-B)+'" role="row" class="ui-widget-content jqfoot ui-row-'+h.p.direction+'">',l+=d(g,B,k.groups,0),l+="</tr>");w=x}}});a("#"+a.jgrid.jqID(h.p.id)+" tbody:first").append(l);l=null})},groupingGroupBy:function(b,e){return this.each(function(){"string"===typeof b&&(b=[b]);var c=this.p.groupingView;this.p.grouping=!0;c._locgr=!1;void 0===c.visibiltyOnNextGrouping&&
...
e||1===e.length&&160===e.charCodeAt(0))e="";var y=a.jgrid.createEl.call(c,m[f].edittype,t,e,!0,a.extend({},a.jgrid.ajaxOptions,c.p.ajaxSelectOptions||{}));a(y).addClass("editable");l?a("span:first",this).append(y):a(this).append(y);a.jgrid.bindEv.call(c,y,t);"select"===m[f].edittype&&void 0!==m[f].editoptions&&!0===m[f].editoptions.multiple&&void 0===m[f].editoptions.dataUrl&&a.jgrid.msie&&a(y).width(a(y).width());g++}}),0<g&&(k.id=b,c.p.savedRow.push(k),a(l).attr("editable","1"),p.focusField&&("number"===
...
afterrestorefunc:null,restoreAfterError:!0,mtype:"POST",saveui:"enable",savetext:a.jgrid.defaults.savetext||"Saving..."},a.jgrid.inlineEdit,l),p=!1,m=this[0],r,q={},n={},t={},u,w,s;if(!m.grid)return p;s=a(m).jqGrid("getInd",b,!0);if(!1===s)return p;k=a.isFunction(l.beforeSaveRow)?l.beforeSaveRow.call(m,l,b):void 0;void 0===k&&(k=!0);if(k){k=a(s).attr("editable");l.url=l.url||m.p.editurl;if("1"===k){var y;a('td[role="gridcell"]',s).each(function(b){y=m.p.colModel[b];r=y.name;if("cb"!==r&&"subgrid"!==
...
"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}w=a.jgrid.checkValues.call(m,q[r],b);if(!1===w[0])return!1;m.p.autoencode&&(q[r]=a.jgrid.htmlEncode(q[r]));"clientArray"!==l.url&&y.editoptions&&!0===y.editoptions.NullIfEmpty&&""===q[r]&&(t[r]="null")}});if(!1===w[0]){try{var A=a(m).jqGrid("getGridRowById",b),v=a.jgrid.findPos(A);a.jgrid.info_dialog(a.jgrid.errors.errcap,w[1],a.jgrid.edit.bClose,{left:v[0],
...
s;else{s=d[m].replace(/\s+/g,"");try{l=1===f?p+s:p+s+"_"+c[g].aggregator+"_"+String(g)}catch(t){}}var u=l=isNaN(parseInt(l,10))?l:l+" ",v=r,y=l,w=e[l],x=c[g].member,A=b,z=void 0;switch(c[g].aggregator){case "sum":z=parseFloat(w||0)+parseFloat(A[x]||0);break;case "count":if(""===w||null==w)w=0;z=A.hasOwnProperty(x)?w+1:0;break;case "min":z=""===w||null==w?parseFloat(A[x]||0):Math.min(parseFloat(w),parseFloat(A[x]||0));break;case "max":z=""===w||null==w?parseFloat(A[x]||0):Math.max(parseFloat(w),parseFloat(A[x]||
0))}e[u]=v[y]=z;1>=m&&"_r_Totals"!==s&&""===p&&(p=s)}h[l]=r;k[l]=q[m]}return e}function t(a){var b,c,d,e,g;for(d in a)if(a.hasOwnProperty(d)){if("object"!==typeof a[d]){if("level"===d){void 0===P[a.level]&&(P[a.level]="",0<a.level&&"_r_Totals"!==a.text&&(p[a.level-1]={useColSpanStyle:!1,groupHeaders:[]}));if(P[a.level]!==a.text&&a.children.length&&"_r_Totals"!==a.text&&0<a.level){p[a.level-1].groupHeaders.push({titleText:a.label,numberOfColumns:0});c=p[a.level-1].groupHeaders.length-1;g=0===c?X:U+
H;if(a.level-1===(m.rowTotals?1:0)&&0<c){var h=p[a.level-1].groupHeaders[c-1].numberOfColumns;h&&(g=h+1+m.aggregates.length)}p[a.level-1].groupHeaders[c].startColumnName=f[g].name;p[a.level-1].groupHeaders[c].numberOfColumns=f.length-g;U=f.length}P[a.level]=a.text}if(a.level===v&&"level"===d&&0<v)if(1<H){c=1;for(b in a.fields)1===c&&p[v-1].groupHeaders.push({startColumnName:b,numberOfColumns:1,titleText:a.text}),c++;p[v-1].groupHeaders[p[v-1].groupHeaders.length-1].numberOfColumns=c-1}else p.splice(v-
1,1)}null!=a[d]&&"object"===typeof a[d]&&t(a[d]);if("level"===d&&0<a.level)for(b in c=0,a.fields)if(a.fields.hasOwnProperty(b)){g={};for(e in m.aggregates[c])if(m.aggregates[c].hasOwnProperty(e))switch(e){case "member":case "label":case "aggregator":break;default:g[e]=m.aggregates[c][e]}1<H?(g.name=b,g.label=m.aggregates[c].label||a.label):(g.name=a.text,g.label="_r_Totals"===a.text?m.rowTotalsText:a.label);f.push(g);c++}}}var u,w,s,y=e.length,A,v,H,B,D=0;m.rowTotals&&0<m.yDimension.length&&(m.yDimension.splice(0,
0,{dataName:m.yDimension[0].dataName}),m.yDimension[0].converter=function(){return"_r_Totals"});A=a.isArray(m.xDimension)?m.xDimension.length:0;v=m.yDimension.length;H=a.isArray(m.aggregates)?m.aggregates.length:0;if(0===A||0===H)throw"xDimension or aggregates optiona are not set!";var C;for(s=0;s<A;s++)C={name:m.xDimension[s].dataName,frozen:m.frozenStaticCols},null==m.xDimension[s].isGroupField&&(m.xDimension[s].isGroupField=!0),C=a.extend(!0,C,m.xDimension[s]),f.push(C);C=A-1;for(var F={};D<y;){u=
e[D];var x=[],M=[];B={};s=0;do x[s]=a.trim(u[m.xDimension[s].dataName]),B[m.xDimension[s].dataName]=x[s],s++;while(s<A);var z=0;w=-1;s=c(g,q,x);if(!s){z=0;if(1<=v){for(z=0;z<v;z++)M[z]=a.trim(u[m.yDimension[z].dataName]),m.yDimension[z].converter&&a.isFunction(m.yDimension[z].converter)&&(M[z]=m.yDimension[z].converter.call(this,M[z],x,M));B=n(u,m.aggregates,M,B)}else 0===v&&(B=n(u,m.aggregates,null,B));g.push(B)}else if(0<=w){z=0;if(1<=v){for(z=0;z<v;z++)M[z]=a.trim(u[m.yDimension[z].dataName]),
m.yDimension[z].converter&&a.isFunction(m.yDimension[z].converter)&&(M[z]=m.yDimension[z].converter.call(this,M[z],x,M));s=n(u,m.aggregates,M,s)}else 0===v&&(s=n(u,m.aggregates,null,s));g[w]=s}u=0;var x=B=null,L;for(L in h)if(h.hasOwnProperty(L)){if(0===u)F.children&&void 0!==F.children||(F={text:L,level:0,children:[],label:L}),B=F.children;else{x=null;for(s=0;s<B.length;s++)if(B[s].text===L){x=B[s];break}x?B=x.children:(B.push({children:[],text:L,level:u,fields:h[L],label:k[L]}),B=B[B.length-1].children)}u++}D++}var P=
[],U=f.length,X=U;0<v&&(p[v-1]={useColSpanStyle:!1,groupHeaders:[]});t(F);if(m.colTotals)for(D=g.length;D--;)for(s=A;s<f.length;s++)y=f[s].name,d[y]=d[y]?d[y]+parseFloat(g[D][y]||0):parseFloat(g[D][y]||0);if(0<C)for(s=0;s<C;s++)f[s].isGroupField&&(l.groupingView.groupField.push(f[s].name),l.groupingView.groupSummary.push(m.groupSummary),l.groupingView.groupSummaryPos.push(m.groupSummaryPos));else l.grouping=!1;l.sortname=f[C].name;l.groupingView.hideFirstGroupCol=!0});return{colModel:f,rows:g,groupOptions:l,
...
2:k[v][m]);c[p]=h;c[m]=h+1}else{h=parseInt(a(g).jqGrid("getCol",m,!1,"max"),10);k=a.jgrid.from(g.p.data).greater(p,h,{stype:"integer"}).select();if(k.length)for(v in k)k.hasOwnProperty(v)&&(k[v][p]=parseInt(k[v][p],10)+2);k=a.jgrid.from(g.p.data).greater(m,h,{stype:"integer"}).select();if(k.length)for(v in k)k.hasOwnProperty(v)&&(k[v][m]=parseInt(k[v][m],10)+2);c[p]=h+1;c[m]=h+2}}if(null===e||a(g).jqGrid("isNodeLoaded",t)||y)a(g).jqGrid("addRowData",b,c,q,s),a(g).jqGrid("setTreeNode",w,n);t&&!t[d]&&
