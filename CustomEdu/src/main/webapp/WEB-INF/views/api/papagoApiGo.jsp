...
<script src="../../../js/api/papagoApi.js"
	type="text/javascript"></script>
...
<link rel="stylesheet"
	href="../../../assets/jquery-ui-1.13.2/jquery-ui.css">
<link rel="stylesheet"
	href="../../../assets/jquery-ui-1.13.2/jquery-ui.structure.css">
<link rel="stylesheet"
	href="../../../assets/jquery-ui-1.13.2/jquery-ui.theme.css">
				...
				<div class="container-fluid">
					<div class="panel">
						<div class="panel-heading">
							<h2 class="panel-title">Papago Api</h2>
						</div>
						<div>
							<div style="padding-left: 20px; padding-right: 20px;">
									<h4>번역</h4>
									<input type="text" id="korean" name="korean"
										 placeholder="번역할 문장을 입력하세요." style="width: 300px">
									<input type="button" value="번역" id="getpapago" name="getpapago" >
									<h4>영어</h4>
