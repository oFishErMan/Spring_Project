							...
							<form action="/board/addBoard" method="post"
								...
								<div style="padding-left: 20px; padding-right: 20px;">
									...
									<input type="text" placeholder="제목을 입력해주세요."
										style="width: 100%; height: 30px" id="board_title"
										autofocus="autofocus" name="board_title">
									<h4>작성자</h4>
									<input type="text" placeholder="이름을 입력해주세요."
										style="width: 100%; height: 30px" id="board_writer"
										name="board_writer">
									<h4>내용</h4>
									<textarea rows="10" style="width: 100%"
										placeholder="내용을 입력해주세요." id="board_text" name="board_text"></textarea>
									<h4>파일</h4>
									<input type="file" id="board_file" name="board_file">
								</div>
								<div style="text-align: center;">
									<button type="submit" class="btn btn-primary" id="regBoard-btn"
